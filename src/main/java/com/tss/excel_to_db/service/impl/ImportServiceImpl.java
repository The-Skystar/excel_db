package com.tss.excel_to_db.service.impl;

import cn.afterturn.easypoi.excel.ExcelImportUtil;
import cn.afterturn.easypoi.excel.entity.ImportParams;
import cn.afterturn.easypoi.excel.entity.result.ExcelImportResult;
import cn.afterturn.easypoi.exception.excel.ExcelImportException;
import com.tss.excel_to_db.mapper.ExcelModelMapper;
...
import com.tss.excel_to_db.redis.RedisDao;
...
public class ImportServiceImpl implements ImportService {
    ...
    public CodeMsg verfiyExcel(MultipartFile file) {
        ...
        // 对上传的数据进行处理，详情信息请看-com.tss.excel_to_db.handler.ExcelModelHandler;
...
//        importParams.setDataHanlder(handler);
        ...
        try {
            ...
            return CodeMsg.userDefinedMsg("时间格式化失败,格式应该为:yyyy-MM-dd");
        } catch (Exception e) {
            log.error(e.getMessage(), e);
        }
...
//        String tuserId = excelModelMapper.queryTuserByUsername(excelModel);
//        excelModel.setTuserID(tuserId);
//        if (StringUtils.isBlank(tuserId)|| StringUtils.isNotBlank(excelModelMapper.queryDataByDate(excelModel))){
//            return false;
//        }
        // INSERT IGNORE  存在重复主键时，返回0
        return excelModelMapper.add(excelModel) > 0;
    }

    /**
     * @Description: 根据不同的失败类型的名称(failTypeName), 返回对应的数据
     * @Param: [failTypeName]
     * @Retrun: java.util.List<com.tss.excel_to_db.domain.ExcelModel>
     */
    @Override
     ...
     * @Param: []
     * @Retrun: com.tss.excel_to_db.vo.ExcelModelVo 封装的值对象
     */
    @Override
